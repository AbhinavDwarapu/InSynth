import {
  ...
  Center,
  Heading,
  Container, Kbd, UnorderedList, ListItem, ScaleFade, Skeleton,
    ...
    <>
      ...
      <Skeleton isLoaded={!isLoading} startColor="custom.50" endColor="custom.200">
        <Container bg="custom.background" maxWidth="100%" minH="100vh">
          ...
          <ScaleFade initialScale={0} in bg="custom.background">
              ...
              <Box width="50%" maxW="50rem" bg="custom.invbackground" py="10px" mb={16} px={1} boxShadow="2xl" rounded="3xl" borderColor="custom.300" borderWidth={1}>
                <Accordion defaultIndex={[0]} allowMultiple>
                  <AccordionItem borderColor="transparent">
                    <h2>
                      <AccordionButton _expanded={{ bg: 'custom.400' }} rounded="xl">
                    ...
                    <AccordionPanel>
                      This project was mostly made as a learning tool for ReactJS, NextJS,
                  ...
                  <AccordionItem borderColor="transparent">
                    ...
                    <AccordionPanel>
                      ...
                      ). Then plug your midi controller in, (your browser may prompt you to enable
                  ...
                  <AccordionItem borderColor="transparent">
                    ...
                    <AccordionPanel>
                      If you do not have a midi controller, or a compatible browser, you can still
                  ...
                  <AccordionItem borderColor="transparent">
                    ...
                    <AccordionPanel>
                      Although frontend testing has been done using Cypress, there are some bugs
                  ...
                  <AccordionItem borderColor="transparent">
                    ...
                    <AccordionPanel>
                      ...
                      . If you find any bugs or have feature requests, please create a new issue
